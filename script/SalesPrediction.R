...
# Reading data -------------
existing_data <- read.csv("/home/aline/Documentos/Ubiqum/Data analytics II/M2T3/SalesPrediction/data/existingproductattributes2017.csv")
new_data <- read.csv("/home/aline/Documentos/Ubiqum/Data analytics II/M2T3/SalesPrediction/data/newproductattributes2017.csv")
...
results <- read.csv("/home/aline/Documentos/Ubiqum/Data analytics II/M2T3/SalesPrediction/data/results.csv")
summary(results)
str(results)
